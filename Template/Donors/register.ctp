                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?= $this->Form->select('salutation',['Mr.'=>'Mr.','Miss'=>'Miss','Mrs.'=>'Mrs.'],array('empty' => 'Salutation','label' => '', 'div' => 'form-group', 'class' => 'form-control', 'placeholder' => 'Salutation', 'data-validation' => 'required')); ?> 
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
